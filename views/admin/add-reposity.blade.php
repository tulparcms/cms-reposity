<form method="POST" action="{{ route('admin.reposity.download') }}" class="ajax-form">
    <div class="row mb-3">
        <label class="col-sm-3 col-form-label" for="basic-icon-default-fullname">{{ __('tulparstudyo/cms-reposity::localize.Input A Github Url') }}</label>
        <div class="col-sm-9">
            <div class="input-group input-group-merge">
                <span id="basic-icon-default-fullname2" class="input-group-text"><i class="ti ti-brand-github"></i></span>
                <input name="reposity" type="text" class="form-control" placeholder="https://github.com/tulparstudyo/cms" >
            </div>
        </div>
    </div>
    <div class="pt-4">
